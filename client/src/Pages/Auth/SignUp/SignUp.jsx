...
function SignUp() {
  ...
  return (
    <div className='flex bg-gray-800 h-full justify-center items-center w-full'>
      <div className='flex flex-col gap-6'>
        <h1 className='ProjectHeader text-3xl text-white text-center mb-4'>Create a new account</h1>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className='col-span-2'>
            ...
            <div>
              <input
                ...
                border-2 text-gray-700 focus:text-white rounded-lg items-center w-full'
                value={form.email}
                name="email"
                id="email"
          ...
          <div>
            <h3 className='font-bold text-lg text-gray-300'>Name</h3>
          ...
          <div>
            <h3 className='font-bold text-lg text-gray-300'>Surname</h3>
            <input
              placeholder='Surname'
              className='mt-1 shadow-sm transition-all focus:bg-transparent 
              bg-gray-100 py-2 px-3 font-bold outline-none border-gray-100 
          ...
          <div>
            <h3 className='font-bold text-lg text-gray-300'>Password</h3>
          ...
          <div>
            <h3 className='font-bold text-lg text-gray-300'>Confirm Password</h3>
            <input
        ...
        <div className='font-semibold text-center text-gray-300'>
