  ...
  return (
    <div className='flex bg-gray-800 h-full justify-center items-center w-full'>
      <div className='flex flex-col gap-6'>
        <h1 className='ProjectHeader text-3xl text-white text-center mb-4'>Sign in to your account</h1>
        <div>
        ...
        <div className="flex justify-center items-center">
          <p className='z-10 bg-gray-800 px-3 font-semibold text-gray-300'>Or continue with</p>
        ...
        <div className='grid grid-cols-2 gap-2'>
          ...
          <button className='flex items-center justify-center transition-all  bg-gray-900 shadow-md font-bold rounded-lg text-white py-1.5'>
